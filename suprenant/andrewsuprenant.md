...
### Personal goals
 ...
 - Likely go back to private sector after this and then back to public sector
 - I'm interested in grad school, including programs that mix public policy/admin and data science
...
Spell out risks and discuss how we might meet them

### Driving principles
 - Firm on vision, flexible on details
 - Just enough process to keep things moving
 BLUF (bottom line up front) – let’s get to the point (or acknowledge that we're just catching up)
...
I’m also an Agile Guild lead, which I give a bit of my time each week for meetings, prep, and other activities
 
 ### Where I can fall down
 ...
 - Starting a message in Slack with just a wave or "hey"...
 Introverted and get tapped out after a number of back to back meeting
...
Schedule
 - Pretty 9-5, typically take a lunch at noon. Usually working an hour before or after that but avoid meetings then.
 - When possible, I avoid meetings on Monday and Fridays, before/after travel 
...
Like working on ways to make regular activities more efficient 
 - Contrarary to what I feel is our thinking here, I want you to interrupt me if you have stopped listening to what I'm saying. I of course want to make sure I'm being heard clearly, but it doesn't do either of us good to talk if the other person has stopped listening for whatever reason.
 - I work from home pretty often. I have been thinking of how I can spend more time in DC but haven't figured that out yet
 I need to be able to write a written summary of something new before I can really understand it. Takes a bit of time
 One thing I will also ask is that if we are having a team meeting, we stay focused on the team meeting and don't do other work/unrelated Slack/etc. I know it could be a bit different for you since you span several projects, but if we're going to set time aside to work together, I would love us to stay focused on that. 
 If we are ever not using time well, let's call that out versus drifting to other stuff. 
 I prefer meetings that start and end on time. I understand long (45-60 minute) meetings can sometimes take a few minutes to get started.
...
Don’t love @ unless I really need to see something right away and/or I’m the only person that can do something about them (I’ll see them in the channel)
...
If I’m understanding the question, I am very comfortable making copy changes in GitHub
I have a lot of HTML/CSS experience and a tiny bit of Javascript
I’d like to deepen my development skills one of these days
I’m generally comfortable poking around to see if I can change/fix something without a high likelihood of breaking it
...
### Things I've worked on or have gotten done here:
- U.S. Forest Service online permitting
- U.S. Navy Naval Air Systems Command (NAVAIR)- [final report](https://docs.google.com/document/d/1UGNp-ue8GsFXwZ5VGjNiIkUtvtxttoAi9UdXjKtDOo4/edit#)
- U.S. Air Force Recruiting Service (AFRS)
- Federal Retirement Thrift Investment Board (FRTIB) tsp.gov 
- Department of Labor (DOL) Wage and Hour Division 
- Consumer Financial Protection Bureau (CFPB)
- cloud.gov (Customer team lead)
- Federalist
- Agile Guild Lead
- Infrastructure Lead for Product Chapter
- Contracting Officer’s Representative (COR) Level I certification
- SAFe, Scrum Master, Scrum Product Owner certifications
- 2018 Design for America Summit Ethics of Social Innovation panelist
- 2018 Region 5 New Employee Orientation speaker
- 2018 Region 5 Day of Development trainer
